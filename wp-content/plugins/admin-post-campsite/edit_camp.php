...
<!--        <tr valign="top">
        ...
        <td><input type="" class="form-control" name="lat" value="<?php echo $camp['camp_latitude']?>" /></td>
        </tr>
		<tr valign="top">
        <th scope="row">Longitude <span style="color:#F00;">*</span></th>
        <td><input type="" class="form-control" name="long" value="<?php echo $camp['camp_longitude']?>" /></td>
        </tr>
