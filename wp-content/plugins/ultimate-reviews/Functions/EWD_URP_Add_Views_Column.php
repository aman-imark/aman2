...
function EWD_URP_Columns_Head($defaults) {
	$defaults['number_of_views'] = __('# of Views', 'EWD_URP');
	$defaults['urp_product'] = __('Product', 'EWD_URP');
	$defaults['urp_score'] = __('Score', 'EWD_URP');
	$defaults['urp_ID'] = __('Post ID', 'EWD_URP');
...
<option value=""><?php _e('Show All Products', 'EWD_URP'); ?></option>
<?php
