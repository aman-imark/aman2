	...
	<div class="woocommerce-product-rating" itemprop="aggregateRating" itemscope itemtype="http://schema.org/AggregateRating">
		<div class="star-rating" title="<?php printf( __( 'Rated %s out of %s', 'woocommerce' ), $average, $Maximum_Score ); ?>">
			<span style="width:<?php echo ( ( $average / $Maximum_Score ) * 100 ); ?>%">
				<strong itemprop="ratingValue" class="rating"><?php echo esc_html( $average ); ?></strong> <?php printf( __( 'out of %s%s%s', 'woocommerce' ), '<span itemprop="bestRating">', $Maximum_Score, '</span>' ); ?>
